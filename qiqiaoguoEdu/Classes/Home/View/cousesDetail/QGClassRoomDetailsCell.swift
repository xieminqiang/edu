...
class QGClassRoomDetailsCell: UITableViewCell {
      ...
      var  orgSign = UILabel()
      var theacherClick = UIButton()
      var timeClick = UIButton()
      var orgClick = UIButton()
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        contentView.addSubview(theacherClick)
        contentView.addSubview(timeClick)
        contentView.addSubview(orgClick)
        ...
        nameLab.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(ageLab.snp.top).offset(fixH(floatHeight: -20))
        }
        ...
        theacherClick.snp.makeConstraints { (make) in
            make.top.equalTo(lineView0.snp.bottom)
            make.left.right.equalTo(contentView)
            make.height.equalTo(44)
        }
        timeClick.snp.makeConstraints { (make) in
            make.top.equalTo(lineView1.snp.bottom)
            make.left.right.equalTo(contentView)
            make.height.equalTo(44)
        }
        orgClick.snp.makeConstraints { (make) in
